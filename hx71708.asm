...
;--------------------------------------------------------
	.area DSEG    (DATA)
_Get_Steady_Weight_sloc0_1_0:
	.ds 1
_Get_Steady_Weight_sloc1_1_0:
	.ds 1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'HX_Init'
;------------------------------------------------------------
;	.\FwLib_STC8\user\hx71708.c:6: void HX_Init(void) {
;	-----------------------------------------
;	 function HX_Init
;	-----------------------------------------
_HX_Init:
	...
	ar1 = 0x01
	ar0 = 0x00
;	.\FwLib_STC8\user\hx71708.c:8: GPIO_P3_SetMode(GPIO_Pin_3, GPIO_Mode_Output_PP);
	mov	a,#0xf7
	anl	a,_P3M0
	orl	a,#0x08
	mov	_P3M0,a
	anl	_P3M1,#0xf7
;	.\FwLib_STC8\user\hx71708.c:9: GPIO_P3_SetMode(GPIO_Pin_2, GPIO_Mode_InOut_QBD);
	anl	_P3M0,#0xfb
	anl	_P3M1,#0xfb
;	.\FwLib_STC8\user\hx71708.c:10: HX_SCK = 0;
;	assignBit
	clr	_P33
;	.\FwLib_STC8\user\hx71708.c:11: }
	ret
;------------------------------------------------------------
...
;	.\FwLib_STC8\user\hx71708.c:45: return (int32_t)count;
	...
	mov	dph,r5
	mov	b,r6
;	.\FwLib_STC8\user\hx71708.c:46: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Get_Steady_Weight'
;------------------------------------------------------------
...
;	.\FwLib_STC8\user\hx71708.c:52: for(uint8_t i = 0; i < samples; i++) {
	...
	mov	_Get_Steady_Weight_sloc1_1_0,#0x00
00107$:
	clr	c
	mov	a,_Get_Steady_Weight_sloc1_1_0
	subb	a,r7
	jnc	00103$
;	.\FwLib_STC8\user\hx71708.c:53: int32_t v = Read_HX71708_Raw();
	push	ar7
	...
	mov	r4, a
	pop	ar7
;	.\FwLib_STC8\user\hx71708.c:54: if(v != -1) {
	cjne	r1,#0xff,00137$
	cjne	r2,#0xff,00137$
	cjne	r3,#0xff,00137$
	cjne	r4,#0xff,00137$
...
;	.\FwLib_STC8\user\hx71708.c:55: sum += v;
	...
	inc	dptr
	movx	@dptr,a
;	.\FwLib_STC8\user\hx71708.c:56: valid++;
	inc	_Get_Steady_Weight_sloc0_1_0
;	.\FwLib_STC8\user\hx71708.c:62: return (sum / (int32_t)valid);
	pop	ar7
;	.\FwLib_STC8\user\hx71708.c:56: valid++;
00108$:
;	.\FwLib_STC8\user\hx71708.c:52: for(uint8_t i = 0; i < samples; i++) {
	inc	_Get_Steady_Weight_sloc1_1_0
	sjmp	00107$
00103$:
;	.\FwLib_STC8\user\hx71708.c:61: if (valid == 0) return -1;
	mov	a,_Get_Steady_Weight_sloc0_1_0
	jnz	00105$
	mov	dptr,#0xffff
	mov	a,#0xff
	mov	b,a
...
00105$:
;	.\FwLib_STC8\user\hx71708.c:62: return (sum / (int32_t)valid);
	mov	r4,_Get_Steady_Weight_sloc0_1_0
	mov	r5,#0x00
	mov	r6,#0x00
	mov	r7,#0x00
	mov	dptr,#_Get_Steady_Weight_sum_10000_60

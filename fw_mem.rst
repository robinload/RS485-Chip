      ...
      00000B                        470 	.ds 3
                                    ...
                                    513 ;	-----------------------------------------
      0001EA                        514 _MEM_SelectWorkRegGroup:
                           000007   515 	ar7 = 0x07
                           000006   516 	ar6 = 0x06
                           000005   517 	ar5 = 0x05
                           000004   518 	ar4 = 0x04
                           ...
                           000001   521 	ar1 = 0x01
                           000000   522 	ar0 = 0x00
      0001EA E5 82            [12]  523 	mov	a,dpl
      0001EC 90 00 09         [24]  524 	mov	dptr,#_MEM_SelectWorkRegGroup_WorkRegGroup_10000_4
      0001EF F0               [24]  525 	movx	@dptr,a
                                    526 ;	FwLib_STC8\src\fw_mem.c:19: RS0 = WorkRegGroup & 0x01;
      0001F0 E0               [24]  527 	movx	a,@dptr
      0001F1 FF               [12]  528 	mov	r7,a
      0001F2 54 01            [12]  529 	anl	a,#0x01
                                    530 ;	assignBit
      0001F4 24 FF            [12]  531 	add	a,#0xff
      0001F6 92 D3            [24]  532 	mov	_RS0,c
                                    533 ;	FwLib_STC8\src\fw_mem.c:20: RS1 = (WorkRegGroup >> 1) & 0x01;
      0001F8 EF               [12]  534 	mov	a,r7
      0001F9 03               [12]  535 	rr	a
      0001FA 54 01            [12]  536 	anl	a,#0x01
                                    537 ;	assignBit
      0001FC 24 FF            [12]  538 	add	a,#0xff
      0001FE 92 D4            [24]  539 	mov	_RS1,c
                                    540 ;	FwLib_STC8\src\fw_mem.c:21: }
      000200 22               [24]  541 	ret
                                    542 ;------------------------------------------------------------
                                    ...
                                    550 ;	-----------------------------------------
      000201                        551 _MEM_SetOnchipExtRAM:
      000201 E5 82            [12]  552 	mov	a,dpl
      000203 90 00 0A         [24]  553 	mov	dptr,#_MEM_SetOnchipExtRAM_HAL_State_10000_6
      000206 F0               [24]  554 	movx	@dptr,a
                                    555 ;	FwLib_STC8\src\fw_mem.c:25: AUXR = AUXR & ~(0x01 << 1) | (HAL_State << 1);
      000207 74 FD            [12]  556 	mov	a,#0xfd
      000209 55 8E            [12]  557 	anl	a,_AUXR
      00020B FF               [12]  558 	mov	r7,a
      00020C E0               [24]  559 	movx	a,@dptr
      00020D 25 E0            [12]  560 	add	a,acc
      00020F 4F               [12]  561 	orl	a,r7
      000210 F5 8E            [12]  562 	mov	_AUXR,a
                                    563 ;	FwLib_STC8\src\fw_mem.c:26: }
      000212 22               [24]  564 	ret
                                    565 ;------------------------------------------------------------
                                    ...
                                    574 ;	-----------------------------------------
      000213                        575 _MEM_ReadChipID:
      000213 AF F0            [24]  576 	mov	r7,b
      000215 AE 83            [24]  577 	mov	r6,dph
      000217 E5 82            [12]  578 	mov	a,dpl
      000219 90 00 0B         [24]  579 	mov	dptr,#_MEM_ReadChipID_buff_10000_8
      00021C F0               [24]  580 	movx	@dptr,a
      00021D EE               [12]  581 	mov	a,r6
      00021E A3               [24]  582 	inc	dptr
      00021F F0               [24]  583 	movx	@dptr,a
      000220 EF               [12]  584 	mov	a,r7
      000221 A3               [24]  585 	inc	dptr
      000222 F0               [24]  586 	movx	@dptr,a
                                    587 ;	FwLib_STC8\src\fw_mem.c:32: P_SW2 = 0x80;
      000223 75 BA 80         [24]  588 	mov	_P_SW2,#0x80
                                    589 ;	FwLib_STC8\src\fw_mem.c:33: for (i = 0; i < 32; i++)
      000226 90 00 0B         [24]  590 	mov	dptr,#_MEM_ReadChipID_buff_10000_8
      000229 E0               [24]  591 	movx	a,@dptr
      00022A FD               [12]  592 	mov	r5,a
      00022B A3               [24]  593 	inc	dptr
      00022C E0               [24]  594 	movx	a,@dptr
      00022D FE               [12]  595 	mov	r6,a
      00022E A3               [24]  596 	inc	dptr
      00022F E0               [24]  597 	movx	a,@dptr
      000230 FF               [12]  598 	mov	r7,a
      000231 7C 00            [12]  599 	mov	r4,#0x00
      000233                        600 00102$:
                                    601 ;	FwLib_STC8\src\fw_mem.c:35: *(buff + i) = MEM_ReadXDATA(CHIPIDxx + i);
      000233 EC               [12]  602 	mov	a,r4
      000234 2D               [12]  603 	add	a, r5
      000235 F9               [12]  604 	mov	r1,a
      000236 E4               [12]  605 	clr	a
      000237 3E               [12]  606 	addc	a, r6
      000238 FA               [12]  607 	mov	r2,a
      000239 8F 03            [24]  608 	mov	ar3,r7
      00023B 8C 00            [24]  609 	mov	ar0,r4
      00023D C0 05            [24]  610 	push	ar5
      00023F C0 06            [24]  611 	push	ar6
      000241 C0 07            [24]  612 	push	ar7
      000243 7F 00            [12]  613 	mov	r7,#0x00
      000245 74 E0            [12]  614 	mov	a,#0xe0
      000247 28               [12]  615 	add	a, r0
      000248 F8               [12]  616 	mov	r0,a
      000249 74 FD            [12]  617 	mov	a,#0xfd
      00024B 3F               [12]  618 	addc	a, r7
      00024C FF               [12]  619 	mov	r7,a
      00024D 88 82            [24]  620 	mov	dpl,r0
      00024F 8F 83            [24]  621 	mov	dph,r7
      000251 E0               [24]  622 	movx	a,@dptr
      000252 89 82            [24]  623 	mov	dpl,r1
      000254 8A 83            [24]  624 	mov	dph,r2
      000256 8B F0            [24]  625 	mov	b,r3
      000258 12 28 6B         [24]  626 	lcall	__gptrput
                                    627 ;	FwLib_STC8\src\fw_mem.c:33: for (i = 0; i < 32; i++)
      00025B 0C               [12]  628 	inc	r4
      00025C BC 20 00         [24]  629 	cjne	r4,#0x20,00119$
      00025F                        630 00119$:
      00025F D0 07            [24]  631 	pop	ar7
      000261 D0 06            [24]  632 	pop	ar6
      000263 D0 05            [24]  633 	pop	ar5
      000265 40 CC            [24]  634 	jc	00102$
                                    635 ;	FwLib_STC8\src\fw_mem.c:37: P_SW2 = 0x00;
      000267 75 BA 00         [24]  636 	mov	_P_SW2,#0x00
                                    637 ;	FwLib_STC8\src\fw_mem.c:38: }
      00026A 22               [24]  638 	ret
                                    639 	.area CSEG    (CODE)
                                    640 	.area CONST   (CODE)
                                    641 	.area XINIT   (CODE)

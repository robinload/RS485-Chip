                                     ...
                                     10 ;--------------------------------------------------------
                                     11 	.globl _main
                                     12 	.globl _MEAS_Process
                                     13 	.globl _reg_init
                                     14 	.globl _mb_parse_request
      ...
      00003F                        453 	.ds	1
                                    ...
                                    480 ;--------------------------------------------------------
                                    481 ; initialized external ram data
                                    482 ;--------------------------------------------------------
      ...
      000000 02 00 8C         [24]  499 	ljmp	__sdcc_gsinit_startup
      000003 32               [24]  500 	reti
      000004                        501 	.ds	7
      00000B 02 1A B9         [24]  502 	ljmp	_Timer0_ISR
      00000E                        503 	.ds	5
      000013 32               [24]  504 	reti
      000014                        505 	.ds	7
      00001B 32               [24]  506 	reti
      00001C                        507 	.ds	7
      000023 02 1A 60         [24]  508 	ljmp	_UART_ISR
      000026                        509 	.ds	5
      00002B 32               [24]  510 	reti
      00002C                        511 	.ds	7
      000033 32               [24]  512 	reti
      000034                        513 	.ds	7
      00003B 32               [24]  514 	reti
      00003C                        515 	.ds	7
      000043 02 1D CB         [24]  516 	ljmp	_UART2_ISR
                                    517 ; restartable atomic support routines
      000046                        518 	.ds	2
      000048                        519 sdcc_atomic_exchange_rollback_start::
      000048 00               [12]  520 	nop
      000049 00               [12]  521 	nop
      00004A                        522 sdcc_atomic_exchange_pdata_impl:
      00004A E2               [24]  523 	movx	a, @r0
      00004B FB               [12]  524 	mov	r3, a
      00004C EA               [12]  525 	mov	a, r2
      00004D F2               [24]  526 	movx	@r0, a
      00004E 80 2C            [24]  527 	sjmp	sdcc_atomic_exchange_exit
      000050 00               [12]  528 	nop
      000051 00               [12]  529 	nop
      000052                        530 sdcc_atomic_exchange_xdata_impl:
      000052 E0               [24]  531 	movx	a, @dptr
      000053 FB               [12]  532 	mov	r3, a
      000054 EA               [12]  533 	mov	a, r2
      000055 F0               [24]  534 	movx	@dptr, a
      000056 80 24            [24]  535 	sjmp	sdcc_atomic_exchange_exit
      000058                        536 sdcc_atomic_compare_exchange_idata_impl:
      000058 E6               [12]  537 	mov	a, @r0
      000059 B5 02 02         [24]  538 	cjne	a, ar2, .+#5
      00005C EB               [12]  539 	mov	a, r3
      00005D F6               [12]  540 	mov	@r0, a
      00005E 22               [24]  541 	ret
      00005F 00               [12]  542 	nop
      000060                        543 sdcc_atomic_compare_exchange_pdata_impl:
      000060 E2               [24]  544 	movx	a, @r0
      000061 B5 02 02         [24]  545 	cjne	a, ar2, .+#5
      000064 EB               [12]  546 	mov	a, r3
      000065 F2               [24]  547 	movx	@r0, a
      000066 22               [24]  548 	ret
      000067 00               [12]  549 	nop
      000068                        550 sdcc_atomic_compare_exchange_xdata_impl:
      000068 E0               [24]  551 	movx	a, @dptr
      000069 B5 02 02         [24]  552 	cjne	a, ar2, .+#5
      00006C EB               [12]  553 	mov	a, r3
      00006D F0               [24]  554 	movx	@dptr, a
      00006E 22               [24]  555 	ret
      00006F                        556 sdcc_atomic_exchange_rollback_end::
                                    557 
      00006F                        558 sdcc_atomic_exchange_gptr_impl::
      00006F 30 F6 E0         [24]  559 	jnb	b.6, sdcc_atomic_exchange_xdata_impl
      000072 A8 82            [24]  560 	mov	r0, dpl
      000074 20 F5 D3         [24]  561 	jb	b.5, sdcc_atomic_exchange_pdata_impl
      000077                        562 sdcc_atomic_exchange_idata_impl:
      000077 EA               [12]  563 	mov	a, r2
      000078 C6               [12]  564 	xch	a, @r0
      000079 F5 82            [12]  565 	mov	dpl, a
      00007B 22               [24]  566 	ret
      00007C                        567 sdcc_atomic_exchange_exit:
      00007C 8B 82            [24]  568 	mov	dpl, r3
      00007E 22               [24]  569 	ret
      00007F                        570 sdcc_atomic_compare_exchange_gptr_impl::
      00007F 30 F6 E6         [24]  571 	jnb	b.6, sdcc_atomic_compare_exchange_xdata_impl
      000082 A8 82            [24]  572 	mov	r0, dpl
      000084 20 F5 D9         [24]  573 	jb	b.5, sdcc_atomic_compare_exchange_pdata_impl
      000087 80 CF            [24]  574 	sjmp	sdcc_atomic_compare_exchange_idata_impl
                                    575 ;--------------------------------------------------------
      ...
      0000EA 02 00 89         [24]  589 	ljmp	__sdcc_program_startup
                                    590 ;--------------------------------------------------------
                                    591 ; Home
                                    592 ;--------------------------------------------------------
                                    593 	.area HOME    (CODE)
                                    594 	.area HOME    (CODE)
      000089                        595 __sdcc_program_startup:
      000089 02 00 ED         [24]  596 	ljmp	_main
                                    ...
                                    604 ;------------------------------------------------------------
                                    605 ;	.\FwLib_STC8\user\main.c:92: void main(void)
                                    606 ;	-----------------------------------------
                                    607 ;	 function main
                                    608 ;	-----------------------------------------
      0000ED                        609 _main:
                           ...
                           000001   616 	ar1 = 0x01
                           000000   617 	ar0 = 0x00
                                    618 ;	.\FwLib_STC8\user\main.c:94: ENABLE_XRAM();
      0000ED 43 BA 80         [24]  619 	orl	_P_SW2,#0x80
                                    620 ;	.\FwLib_STC8\user\main.c:96: UART_Init();   // UART1 (debug) + Timer2 (baud) + Timer0 (Modbus frame gap)
      0000F0 12 1A 2B         [24]  621 	lcall	_UART_Init
                                    622 ;	.\FwLib_STC8\user\main.c:97: UART2_Init();  // UART2 (RS485 Modbus) on P1.0/P1.1
      0000F3 12 1D AC         [24]  623 	lcall	_UART2_Init
                                    624 ;	.\FwLib_STC8\user\main.c:99: reg_init();
      0000F6 12 18 CC         [24]  625 	lcall	_reg_init
                                    626 ;	.\FwLib_STC8\user\main.c:101: UART_SendString("BOOT_OK\r\n"); // Debug confirms boot on UART1
      0000F9 90 26 86         [24]  627 	mov	dptr,#___str_0
      0000FC 75 F0 80         [24]  628 	mov	b, #0x80
      0000FF 12 1B 5F         [24]  629 	lcall	_UART_SendString
                                    630 ;	.\FwLib_STC8\user\main.c:103: ET0 = 1;        // Timer0 interrupt (frame gap detection)
                                    631 ;	assignBit
      000102 D2 A9            [12]  632 	setb	_ET0
                                    633 ;	.\FwLib_STC8\user\main.c:104: ES  = 1;        // UART1 interrupt (debug, TX only)
                                    634 ;	assignBit
      000104 D2 AC            [12]  635 	setb	_ES
                                    636 ;	.\FwLib_STC8\user\main.c:105: IE2 |= 0x01;    // UART2 interrupt (Modbus RX)
      000106 43 AF 01         [24]  637 	orl	_IE2,#0x01
                                    638 ;	.\FwLib_STC8\user\main.c:106: EA  = 1;        // Global enable
                                    639 ;	assignBit
      000109 D2 AF            [12]  640 	setb	_EA
                                    641 ;	.\FwLib_STC8\user\main.c:108: while (1)
      00010B                        642 00104$:
                                    643 ;	.\FwLib_STC8\user\main.c:110: WDT_CONTR = 0x35;
      00010B 75 C1 35         [24]  644 	mov	_WDT_CONTR,#0x35
                                    645 ;	.\FwLib_STC8\user\main.c:112: MEAS_Process();
      00010E 12 0C CC         [24]  646 	lcall	_MEAS_Process
                                    647 ;	.\FwLib_STC8\user\main.c:114: if (mb_frame_ready)
      000111 90 01 D4         [24]  648 	mov	dptr,#_mb_frame_ready
      000114 E0               [24]  649 	movx	a,@dptr
      000115 60 F4            [24]  650 	jz	00104$
                                    651 ;	.\FwLib_STC8\user\main.c:116: EA = 0;
                                    652 ;	assignBit
      000117 C2 AF            [12]  653 	clr	_EA
                                    654 ;	.\FwLib_STC8\user\main.c:117: mb_parse_request();
      000119 12 08 4B         [24]  655 	lcall	_mb_parse_request
                                    656 ;	.\FwLib_STC8\user\main.c:118: mb_idx = 0;
      00011C 90 01 D3         [24]  657 	mov	dptr,#_mb_idx
      00011F E4               [12]  658 	clr	a
      000120 F0               [24]  659 	movx	@dptr,a
                                    660 ;	.\FwLib_STC8\user\main.c:119: mb_frame_ready = 0;
      000121 90 01 D4         [24]  661 	mov	dptr,#_mb_frame_ready
      000124 F0               [24]  662 	movx	@dptr,a
                                    663 ;	.\FwLib_STC8\user\main.c:120: EA = 1;
                                    664 ;	assignBit
      000125 D2 AF            [12]  665 	setb	_EA
                                    666 ;	.\FwLib_STC8\user\main.c:123: }
      000127 80 E2            [24]  667 	sjmp	00104$
                                    668 	.area CSEG    (CODE)
                                    669 	.area CONST   (CODE)
                                    670 	.area CONST   (CODE)
      002686                        671 ___str_0:
      002686 42 4F 4F 54 5F 4F 4B   672 	.ascii "BOOT_OK"
      00268D 0D                     673 	.db 0x0d
      00268E 0A                     674 	.db 0x0a
      00268F 00                     675 	.db 0x00
                                    676 	.area CSEG    (CODE)
                                    677 	.area XINIT   (CODE)

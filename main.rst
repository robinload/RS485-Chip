      ...
      000029 00               [12]  512 	nop
      00002A                        513 sdcc_atomic_exchange_pdata_impl:
      00002A E2               [24]  514 	movx	a, @r0
      00002B FB               [12]  515 	mov	r3, a
      00002C EA               [12]  516 	mov	a, r2
      00002D F2               [24]  517 	movx	@r0, a
      00002E 80 2C            [24]  518 	sjmp	sdcc_atomic_exchange_exit
      000030 00               [12]  519 	nop
      000031 00               [12]  520 	nop
      000032                        521 sdcc_atomic_exchange_xdata_impl:
      000032 E0               [24]  522 	movx	a, @dptr
      000033 FB               [12]  523 	mov	r3, a
      000034 EA               [12]  524 	mov	a, r2
      000035 F0               [24]  525 	movx	@dptr, a
      000036 80 24            [24]  526 	sjmp	sdcc_atomic_exchange_exit
      000038                        527 sdcc_atomic_compare_exchange_idata_impl:
      000038 E6               [12]  528 	mov	a, @r0
      000039 B5 02 02         [24]  529 	cjne	a, ar2, .+#5
      00003C EB               [12]  530 	mov	a, r3
      00003D F6               [12]  531 	mov	@r0, a
      00003E 22               [24]  532 	ret
      00003F 00               [12]  533 	nop
      000040                        534 sdcc_atomic_compare_exchange_pdata_impl:
      000040 E2               [24]  535 	movx	a, @r0
      000041 B5 02 02         [24]  536 	cjne	a, ar2, .+#5
      000044 EB               [12]  537 	mov	a, r3
      000045 F2               [24]  538 	movx	@r0, a
      000046 22               [24]  539 	ret
      000047 00               [12]  540 	nop
      000048                        541 sdcc_atomic_compare_exchange_xdata_impl:
      000048 E0               [24]  542 	movx	a, @dptr
      000049 B5 02 02         [24]  543 	cjne	a, ar2, .+#5
      00004C EB               [12]  544 	mov	a, r3
      00004D F0               [24]  545 	movx	@dptr, a
      00004E 22               [24]  546 	ret
      00004F                        547 sdcc_atomic_exchange_rollback_end::
                                    548 
      00004F                        549 sdcc_atomic_exchange_gptr_impl::
      00004F 30 F6 E0         [24]  550 	jnb	b.6, sdcc_atomic_exchange_xdata_impl
      000052 A8 82            [24]  551 	mov	r0, dpl
      000054 20 F5 D3         [24]  552 	jb	b.5, sdcc_atomic_exchange_pdata_impl
      000057                        553 sdcc_atomic_exchange_idata_impl:
      000057 EA               [12]  554 	mov	a, r2
      000058 C6               [12]  555 	xch	a, @r0
      000059 F5 82            [12]  556 	mov	dpl, a
      00005B 22               [24]  557 	ret
      00005C                        558 sdcc_atomic_exchange_exit:
      00005C 8B 82            [24]  559 	mov	dpl, r3
      00005E 22               [24]  560 	ret
      00005F                        561 sdcc_atomic_compare_exchange_gptr_impl::
      00005F 30 F6 E6         [24]  562 	jnb	b.6, sdcc_atomic_compare_exchange_xdata_impl
      000062 A8 82            [24]  563 	mov	r0, dpl
      000064 20 F5 D9         [24]  564 	jb	b.5, sdcc_atomic_compare_exchange_pdata_impl
      000067 80 CF            [24]  565 	sjmp	sdcc_atomic_compare_exchange_idata_impl
                                    566 ;--------------------------------------------------------
      ...
      0000CA 02 00 69         [24]  580 	ljmp	__sdcc_program_startup
                                    581 ;--------------------------------------------------------
                                    582 ; Home
                                    583 ;--------------------------------------------------------
                                    584 	.area HOME    (CODE)
                                    585 	.area HOME    (CODE)
      000069                        586 __sdcc_program_startup:
      000069 02 00 CD         [24]  587 	ljmp	_main
                                    ...
                                    595 ;------------------------------------------------------------
                                    596 ;	.\FwLib_STC8\user\main.c:20: void main(void)
                                    597 ;	-----------------------------------------
                                    598 ;	 function main
                                    599 ;	-----------------------------------------
      0000CD                        600 _main:

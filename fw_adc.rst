                                    ...
                                    213 	.globl _SP
                                    214 	.globl _P0
                                    215 	.globl _ADC_Convert
                                    216 	.globl _ADC_ConvertHP
                                    217 ;--------------------------------------------------------
      ...
      000000                        435 	.ds 8
                                    ...
                                    497 	.area CSEG    (CODE)
                                    498 ;------------------------------------------------------------
                                    499 ;Allocation info for local variables in function 'ADC_Convert'
                                    500 ;------------------------------------------------------------
                                    501 ;	.\FwLib_STC8\src\fw_adc.c:18: uint8_t ADC_Convert(void)
                                    502 ;	-----------------------------------------
                                    503 ;	 function ADC_Convert
                                    504 ;	-----------------------------------------
      000811                        505 _ADC_Convert:
                           000007   506 	ar7 = 0x07
                           000006   507 	ar6 = 0x06
                           000005   508 	ar5 = 0x05
                           000004   509 	ar4 = 0x04
                           ...
                           000001   512 	ar1 = 0x01
                           000000   513 	ar0 = 0x00
                                    514 ;	.\FwLib_STC8\src\fw_adc.c:20: ADC_Start();
      000811 43 BC 40         [24]  515 	orl	_ADC_CONTR,#0x40
                                    516 ;	.\FwLib_STC8\src\fw_adc.c:21: NOP();
      000814 00               [12]  517 	NOP	
                                    518 ;	.\FwLib_STC8\src\fw_adc.c:22: NOP();
      000815 00               [12]  519 	NOP	
                                    520 ;	.\FwLib_STC8\src\fw_adc.c:23: while (!ADC_SamplingFinished());
      000816                        521 00101$:
      000816 E5 BC            [12]  522 	mov	a,_ADC_CONTR
      000818 30 E5 FB         [24]  523 	jnb	acc.5,00101$
                                    524 ;	.\FwLib_STC8\src\fw_adc.c:24: ADC_ClearInterrupt();
      00081B 53 BC DF         [24]  525 	anl	_ADC_CONTR,#0xdf
                                    526 ;	.\FwLib_STC8\src\fw_adc.c:25: return ADC_RES;
      00081E 85 BD 82         [24]  527 	mov	dpl, _ADC_RES
                                    528 ;	.\FwLib_STC8\src\fw_adc.c:26: }
      000821 22               [24]  529 	ret
                                    530 ;------------------------------------------------------------
                                    531 ;Allocation info for local variables in function 'ADC_ConvertHP'
                                    532 ;------------------------------------------------------------
                                    533 ;res           Allocated with name '_ADC_ConvertHP_res_10000_6'
                                    534 ;------------------------------------------------------------
                                    535 ;	.\FwLib_STC8\src\fw_adc.c:28: uint16_t ADC_ConvertHP(void)
                                    536 ;	-----------------------------------------
                                    537 ;	 function ADC_ConvertHP
                                    538 ;	-----------------------------------------
      000822                        539 _ADC_ConvertHP:
                                    540 ;	.\FwLib_STC8\src\fw_adc.c:31: ADC_Start();
      000822 43 BC 40         [24]  541 	orl	_ADC_CONTR,#0x40
                                    542 ;	.\FwLib_STC8\src\fw_adc.c:32: NOP();
      000825 00               [12]  543 	NOP	
                                    544 ;	.\FwLib_STC8\src\fw_adc.c:33: NOP();
      000826 00               [12]  545 	NOP	
                                    546 ;	.\FwLib_STC8\src\fw_adc.c:34: while (!ADC_SamplingFinished());
      000827                        547 00101$:
      000827 E5 BC            [12]  548 	mov	a,_ADC_CONTR
      000829 30 E5 FB         [24]  549 	jnb	acc.5,00101$
                                    550 ;	.\FwLib_STC8\src\fw_adc.c:35: ADC_ClearInterrupt();
      00082C 53 BC DF         [24]  551 	anl	_ADC_CONTR,#0xdf
                                    552 ;	.\FwLib_STC8\src\fw_adc.c:36: res = ADC_RES;
                                    553 ;	.\FwLib_STC8\src\fw_adc.c:37: return (res << 8) + ADC_RESL;
      00082F AF BD            [24]  554 	mov	r7,_ADC_RES
      000831 7E 00            [12]  555 	mov	r6,#0x00
      000833 AC BE            [24]  556 	mov	r4,_ADC_RESL
      000835 7D 00            [12]  557 	mov	r5,#0x00
      000837 EC               [12]  558 	mov	a,r4
      000838 2E               [12]  559 	add	a, r6
      000839 FC               [12]  560 	mov	r4,a
      00083A ED               [12]  561 	mov	a,r5
      00083B 3F               [12]  562 	addc	a, r7
                                    563 ;	.\FwLib_STC8\src\fw_adc.c:38: }
      00083C 8C 82            [24]  564 	mov	dpl,r4
      00083E F5 83            [12]  565 	mov	dph,a
      000840 22               [24]  566 	ret
                                    567 	.area CSEG    (CODE)
                                    568 	.area CONST   (CODE)
                                    569 	.area XINIT   (CODE)
